...
//web.xml에 저장된 컽텍스트 초기화 파라미터를 application객체를 통해 가져옴
...
//필수 파라미터인 bname을 DAO로 전달하기위해 Map컬렉션에 저장한다.
...
//전체페이지수 걔선 => 105개/10 => 10.5 => ceil(10.5) => 11
int totalPage = (int)Math.ceil((double)totalRecordCount/pageSize);

/* 
현재페이지번호 : 파라미터가 없을 때는 무조건 1페이지로 지정하고, 있을 때는 해당값을
...
//게시물의 범위를 Map컬렉션ㄴ에 저장하고 DAO로 전달한다.
